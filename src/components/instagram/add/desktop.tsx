    ...
    return (
        <div>
            ...
            <p className="about-title" data-aos="fade-up">
                ...
                추가하려면 <span className="white">TodayLunch 개발진들</span>
                에게 <span className="white">요청</span>해야 합니다.
                <br />
            ...
            <p className="about-text" data-aos="fade-up">
                ...
                <br />
                - 학교 OR TodayLunch
                <br />- TodayLunch에서 계정을 직접 운영하는 것을 우선적으로 함
                <br />
                <br />
                <span className="white">
                    2. 기존 계정이 있는 경우 계정 이관 가능 여부 확인
                </span>
                <br />- 이관 불가능하면 가급적 기존 계정 탈퇴 후 새로 생성
                <br />- 급식 계정이 여러 개면 혼동 가능성이 다분함
                <br />
                <br />
                <span className="white">3. Instagram 계정 정보 변경 요청</span>
                <br />
                - 소개 메시지 수정 요청 시 수정 가능 (단, TodayLunch 개발진들
                정보 유지)
                <br />
                - 학교 시그니처(로고) 등 별도 프로필 사진 적용 요청 시 적용 가능
                <br />
                - 스토리 커스텀 탬플릿 요청 가능
                <br /> - TodayLunch 로고 축소 및 이동은 가능하지만 제거 불가
                <br />
                <br />
                <span className="white">4. 업로드 항목 검토 요청</span>
                <br /> - 업로드 요청 사항은 TodayLunch 개발진들 Instagram DM으로
                요청
                <br />- 매일 00:05 급식 메뉴 스토리 업로드
                <br />- 오류 발생 수동 업로드
                <br /> - Instagram 하이라이트에 급식 메뉴 아카이브
                <br /> - 매주 주말에 다음 주 주요 급식 메뉴 미리 보기 업로드
                예정
                <br /> - TodayLunch 앱 광고(월 1회 미만 예정)
                <br /> - 급식실 공지 사항 업로드 가능
                <br />- 업로드될 사항은 TodayLunch 개발진들 Instagram DM으로
                요청
            </p>
            ...
            <p className="about-text" data-aos="fade-up">
                ...
                <br />- 공식적인 급식 알림 계정이 있으면 계정 생성 불가
                <br />
                <br />
                <span className="white">3. 계정 정보 수정 불가</span>
                <br />- 학교 측의 공식적인 요청이 아닐 경우 TodayLunch 템플릿
                적용
            </p>
